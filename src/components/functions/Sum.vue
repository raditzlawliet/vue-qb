<template>
  <div :data-depth="depth">
    <div v-if="normalizedTemplateOptions.template =='bs4'">
      <div>
        <slot name="f-sum-begin">
          <label class="col-form-label col-form-label-sm">SUM (</label>
        </slot>
      </div>
      <div class="ml-2">
        <slot name="f-sum-value">
          <dynamic-selector
            ref="value"
    ...
    <div v-if="normalizedTemplateOptions.template =='bs3'">
      <label class="control-label input-sm">SUM (</label>
      <div class="ml-2">
        <dynamic-selector
          ref="value"
          :query="querylocal.value"
