<template>
  <div :data-depth="depth">
    <div v-if="normalizedTemplateOptions.template =='bs4'">
      <div>
        <slot name="f-min-begin">
          <label class="col-form-label col-form-label-sm">MIN (</label>
        </slot>
      </div>
      <div class="ml-2">
        <slot name="f-min-value">
          <dynamic-selector
            ref="value"
    ...
    <div v-if="normalizedTemplateOptions.template =='bs3'">
      <label class="control-label input-sm">MIN (</label>
      <div class="ml-2">
        <dynamic-selector
          ref="value"
          :query="querylocal.value"
