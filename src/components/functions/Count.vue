<template>
  <div :data-depth="depth">
    <div v-if="normalizedTemplateOptions.template =='bs4'">
      <div>
        <slot name="f-count-begin">
          <label class="col-form-label col-form-label-sm">COUNT (</label>
        </slot>
      </div>
      <div class="ml-2">
        <slot name="f-count-value">
          <dynamic-selector
            ref="value"
    ...
    <div v-if="normalizedTemplateOptions.template =='bs3'">
      <label class="control-label input-sm">COUNT (</label>
      <div class="ml-2">
        <dynamic-selector
          ref="value"
          :query="querylocal.value"
